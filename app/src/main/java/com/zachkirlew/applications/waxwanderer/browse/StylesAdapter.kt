...
class StylesAdapter(private var styles: List<Style>) : RecyclerView.Adapter<StylesAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StylesAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.browse_item, parent, false)
        return ViewHolder(v)
    }

    override fun onBindViewHolder(holder: StylesAdapter.ViewHolder, position: Int) {
